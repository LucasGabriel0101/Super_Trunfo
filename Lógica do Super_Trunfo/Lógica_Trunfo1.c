...
// A segunda carta segue o mesmo padrão da Primeira Carta
  ...
  printf("---------------------------------------\n");
  printf("Carta 1 - Sao Paulo(SP): %d\n", Populacao1);                     // Dados das Duas Populações das Cidades
  printf("Carta 2 - Rio de Janeiro(RJ): %d\n", Populacao2);


   // If-Else//
printf("---------------------------------------\n");
   if (Populacao1 > Populacao2){                           // Se a Populacao1 for Maior que a Populacao2 ele Vence, caso ao contrário ele Perde
    printf("Carta 1 - Sao Paulo(SP) Venceu!\n");
   }else{
    printf("Carta 1 - Sao Paulo(SP) Perdeu!\n");
   }

   if (Populacao2 > Populacao1){                           // Se a Populacao2 for Maior que a Populacao1 ele Vence, caso ao contrário ele Perde
    printf("Carta 2 - Rio de Janeiro(RJ) Venceu!\n");
   }else{
    printf("Carta 2 - Rio de Janeiro(RJ)Perdeu!\n");
   }
printf("---------------------------------------\n");
